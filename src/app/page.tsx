...
export default function HomePage() {
  ...
  return (
    <div className="relative min-h-screen w-full bg-slate-950 text-slate-100 overflow-x-hidden">
      ...
      <section className="relative min-h-[85vh] lg:min-h-[90vh] flex items-center border-b border-slate-800/80 overflow-hidden py-12 sm:py-20">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6 text-left">
              <div className="inline-flex items-center gap-2 bg-amber-500/10 border border-amber-500/30 text-amber-300 font-bold text-xs px-3.5 py-1.5 rounded-full backdrop-blur-md shadow-lg">
              ...
              <div className="text-amber-400 font-semibold text-base sm:text-lg tracking-wide">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 pt-2">
                <div className="border border-slate-800/90 bg-slate-900/80 p-3 rounded-xl text-xs flex items-center gap-2.5 backdrop-blur-md shadow-md">
              ...
              <div className="flex flex-wrap items-center gap-3.5 pt-4">
                ...
                <a
                  ...
                  className="bg-slate-900/90 hover:bg-slate-800 text-white font-bold px-5 py-3.5 rounded-xl text-sm transition-all border border-slate-700/80 flex items-center gap-2"
                >
            ...
            <div className="lg:col-span-5">
              <div className="border border-slate-800/90 bg-slate-900/90 rounded-2xl sm:rounded-3xl p-5 sm:p-7 shadow-2xl backdrop-blur-xl space-y-4">
                ...
                <h3 className="text-xl font-extrabold text-white">Planning Interior Work?</h3>
      ...
      <div className="relative z-10 space-y-20 sm:space-y-28 py-16">
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {BUSINESS_INFO.strengths.map((strength, index) => (
              <div
                key={index}
                className="border border-slate-850 bg-slate-900/70 hover:border-amber-500/40 p-6 rounded-2xl transition-all space-y-3 group shadow-lg"
              >
                <div className="w-10 h-10 rounded-xl bg-amber-500/10 border border-amber-500/20 text-amber-400 flex items-center justify-center font-bold text-sm group-hover:scale-110 transition-transform">
                  0{index + 1}
                </div>
                <h3 className="font-bold text-white text-base leading-snug">{strength}</h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {ALL_SERVICES.slice(0, 9).map((service) => (
              <Link
                ...
                className="border border-slate-850 bg-slate-900/70 hover:border-amber-500/50 p-6 rounded-2xl transition-all space-y-3 group block shadow-lg"
              >
        ...
        <section className="border-y border-slate-850 bg-slate-900/40 py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              {BUSINESS_INFO.primaryLocations.map((loc) => (
                <div
                  key={loc}
                  className="border border-slate-800 bg-slate-950/80 p-6 rounded-2xl space-y-3 text-center shadow-lg"
                >
                  <div className="w-12 h-12 bg-amber-500/10 text-amber-400 rounded-full flex items-center justify-center mx-auto border border-amber-500/20 shadow-md">
                    <MapPin className="w-6 h-6" />
                  </div>
                  <h3 className="text-xl font-bold text-white">{loc}</h3>
                  <p className="text-xs text-slate-400 leading-relaxed">
